...
writeACC(CTRL_REG1_M, 0b00100000) #z,y,x axis enabled, continuos update,  100Hz data rate
writeACC(CTRL_REG2_M, 0b00000000) #+/- 4G full scale

#initialise the magnetometer
writeMAG(CTRL_REG5_M, 0b11110000) #Temp enable, M data rate = 50Hz
writeMAG(CTRL_REG6_M, 0b01100000) #+/-12gauss
writeMAG(CTRL_REG7_M, 0b00000000) #Continuous-conversion mode
...
while True:
	...
	#Calculate tilt compensated heading
        ...
        if 0:
                print("\n##### MAGY,MAGX, MAGZ = %f %f %f  #####" % (MAGy, MAGx, MAGz))

        if 0:
                print("\n##### pitch, roll = %f %f  #####" % (pitch, roll))
        if 1:
	...
	if 0:			#Change to '0' to stop  showing the angles from the gyro
 	...
 	if 0:			#Change to '0' to stop  showing the heading
		print ("\n HEADING  %5.2f \33[1;37;40m tiltCompensatedHeading %5.2f" % (heading,tiltCompensatedHeading))
