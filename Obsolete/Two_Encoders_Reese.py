...
def main():
   global Rotary_counter_L, Rotary_counter_R, LockRotary_R, LockRotary_L
   ...
   while True :                        # start test
      ...
      print ("Right Distance = " + str(NewCounter_R*0.056*3.14159/400) + "Right Velocity = " + str(V_R))
