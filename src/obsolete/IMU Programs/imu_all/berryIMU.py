...
writeACC(CTRL_REG1_M, 0b01100111) #z,y,x axis enabled, continuos update,  100Hz data rate
writeACC(CTRL_REG2_M, 0b00100000) #+/- 16G full scale
...
while True:
	...
	if 0:			#Change to '0' to stop  showing the angles from the Kalman filter
		print ("\033[1;31;40m kalmanX %5.2f  \033[1;35;40m kalmanY %5.2f  \n" % (kalmanX,kalmanY))
